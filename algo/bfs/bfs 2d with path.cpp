...
////    do
//    {
//        cout << path[des_x][des_y].x <<path[des_x][des_y].y<< " ";
//        des_x=path[des_x][des_y].x;
//        des_y=path[des_x][des_y].y;
//
//    }
//    while (path[des_x][des_y].x != 0 || path[des_x][des_y].y!= 0);

    cout << "destina tion point ["<<des_x+1<<"," <<des_y+1<< "] ";
//
//    while (level[des_x][des_y]!= 0)
//    {   //cout<<"des: "<<des_x<<","<<des_y<<"  "<<level[des_x][des_y];
//        cout << " <-  ["<<path[des_x][des_y].x<<"," <<path[des_x][des_y].y<< "] ";
//        des_x=path[des_x][des_y].x;
//        des_y=path[des_x][des_y].y;
//       // cout<<"   after: "<<des_x<<","<<des_y<<"  \n";
//
//    }
//    cout<<endl;
